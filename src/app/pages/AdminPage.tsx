            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="bolsas-tecnicas">Bolsas técnicas</option>
                  <option value="capas-protecao">Capas de proteção</option>
                  <option value="bones">Bonés</option>
                  <option value="personalizados">Projetos personalizados</option>
                </select>
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-6">
              ...
              <p className="text-sm text-gray-500 leading-relaxed mb-5">
                Ao salvar, o produto ficará disponível para aparecer no catálogo conforme a
