        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {steps.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="bg-white rounded-xl border border-gray-100 p-5 text-center hover:shadow-md transition-shadow relative overflow-hidden">
              ...
              <h3 className="font-bold text-[#111111] mb-1 text-sm">{title}</h3>
          ...
          <div>
            {sent ? (
              <div className="bg-white rounded-xl border border-gray-100 p-10 text-center flex flex-col items-center justify-center h-full">
                ...
                <h3 className="text-xl font-black text-[#111111] mb-2">Solicitação Enviada!</h3>
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-100 p-6">
                <h2 className="font-black text-[#111111] text-xl mb-5">Solicitar Orçamento</h2>
                <div className="space-y-4">
                    ...
                    {[
                      ...
                      <div key={f.name}>
                        ...
                        <input type={f.type} required value={form[f.name as keyof typeof form]}
                          ...
                          className="w-full border border-gray-200 rounded-md px-3 py-2 text-sm outline-none focus:border-[#111111]" />
                      </div>
                    ))}
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <textarea rows={4} value={form.description}
                      ...
                      className="w-full border border-gray-200 rounded-md px-3 py-2 text-sm outline-none focus:border-[#111111] resize-none" />
                  </div>
